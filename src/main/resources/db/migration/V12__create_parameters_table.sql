           ...
           <tbody>
               ...
               <tr>
                   ...
                   <td colspan="2"
                       ...
                       width="143">
                       <span style="font-size:9.0pt">
                           <span style="font-family:&quot;Arial&quot;,sans-serif" data-th-text="${#temporals.format(realizationTerm.internshipStartDate, ''dd/MM/yyyy'')}"> a </span> <span style="font-family:&quot;Arial&quot;,sans-serif" data-th-text="${#temporals.format(realizationTerm.internshipEndDate, ''dd/MM/yyyy'')}"></span>
                       </span>
                   </td>
                   <td nowrap="nowrap"
                       style="
